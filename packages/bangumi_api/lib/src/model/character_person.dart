...
/// * [staff]
@BuiltValue()
abstract class CharacterPerson
    implements Built<CharacterPerson, CharacterPersonBuilder> {
  ...
  factory CharacterPerson([void updates(CharacterPersonBuilder b)]) =
      _$CharacterPerson;
  ...
  static Serializer<CharacterPerson> get serializer =>
      _$CharacterPersonSerializer();
}

class _$CharacterPersonSerializer
    implements PrimitiveSerializer<CharacterPerson> {
  @override
