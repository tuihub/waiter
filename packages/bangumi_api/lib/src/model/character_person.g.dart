...
CharacterPerson _$CharacterPersonFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'CharacterPerson',
      json,
      ($checkedConvert) {
...
Map<String, dynamic> _$CharacterPersonToJson(CharacterPerson instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
