...
class DefaultApi {
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> collectCharacterByCharacterIdAndUserId({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> collectPersonByPersonIdAndUserId({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetMyself200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetMyself200Response>> getMyself({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    return Response<GetMyself200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PagedSubject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedSubject>> getSubjects({
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserCharacterCollection] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserCharacterCollection>> getUserCharacterCollection({
    required String username,
    required int characterId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    return Response<UserCharacterCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PagedUserCharacterCollection] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedUserCharacterCollection>> getUserCharacterCollections({
    required String username,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    return Response<PagedUserCharacterCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserPersonCollection] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserPersonCollection>> getUserPersonCollection({
    required String username,
    required int personId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    return Response<UserPersonCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PagedUserPersonCollection] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedUserPersonCollection>> getUserPersonCollections({
    required String username,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    return Response<PagedUserPersonCollection>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [PagedSubject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PagedSubject>> searchSubjects({
    int? limit,
    int? offset,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> uncollectCharacterByCharacterIdAndUserId({
    required int characterId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> uncollectPersonByPersonIdAndUserId({
    required int personId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
