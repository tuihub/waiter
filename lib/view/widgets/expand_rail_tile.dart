...
/// [ExpandRailTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [ExpandRailTile].
///
/// {@tool dartpad}
...
class ExpandRailTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const ExpandRailTile({
    super.key,
    this.leading,
    required this.title,
  ...
  @override
  State<ExpandRailTile> createState() => _ExpandRailTileState();
}

class _ExpandRailTileState extends State<ExpandRailTile>
