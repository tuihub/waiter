...
class NotifyFlowEditPage extends StatefulWidget {
  const NotifyFlowEditPage({super.key});
                ...
                ElevatedButton(
                  onPressed: () {
                    if (formKey.currentState!.validate()) {
                      ...
                      context
                          .read<NetzachBloc>()
                          .add(NetzachFlowEditEvent(NotifyFlow(
                            id: state
                                .notifyFlows![state.notifyFlowEditIndex!].id,
                            name: name,
