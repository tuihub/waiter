...
class LocalAppInstRunRecordMapper
    extends ClassMapperBase<LocalAppInstRunRecord> {
  LocalAppInstRunRecordMapper._();

  static LocalAppInstRunRecordMapper? _instance;
  static LocalAppInstRunRecordMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = LocalAppInstRunRecordMapper._());
    }
    return _instance!;
  }

  @override
  final String id = 'LocalAppInstRunRecord';

  static String _$uuid(LocalAppInstRunRecord v) => v.uuid;
  static const Field<LocalAppInstRunRecord, String> _f$uuid =
      Field('uuid', _$uuid);
  static DateTime? _$startTime(LocalAppInstRunRecord v) => v.startTime;
  static const Field<LocalAppInstRunRecord, DateTime> _f$startTime =
      Field('startTime', _$startTime, opt: true);
  static DateTime? _$endTime(LocalAppInstRunRecord v) => v.endTime;
  static const Field<LocalAppInstRunRecord, DateTime> _f$endTime =
      Field('endTime', _$endTime, opt: true);

  @override
  final MappableFields<LocalAppInstRunRecord> fields = const {
    #uuid: _f$uuid,
    #startTime: _f$startTime,
    #endTime: _f$endTime,
  };

  static LocalAppInstRunRecord _instantiate(DecodingData data) {
    return LocalAppInstRunRecord(
        uuid: data.dec(_f$uuid),
  ...
  static LocalAppInstRunRecord fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<LocalAppInstRunRecord>(map);
  }

  static LocalAppInstRunRecord fromJson(String json) {
    return ensureInitialized().decodeJson<LocalAppInstRunRecord>(json);
  }
}

mixin LocalAppInstRunRecordMappable {
  String toJson() {
    return LocalAppInstRunRecordMapper.ensureInitialized()
        .encodeJson<LocalAppInstRunRecord>(this as LocalAppInstRunRecord);
  }

  Map<String, dynamic> toMap() {
    return LocalAppInstRunRecordMapper.ensureInitialized()
        .encodeMap<LocalAppInstRunRecord>(this as LocalAppInstRunRecord);
  }

  LocalAppInstRunRecordCopyWith<LocalAppInstRunRecord, LocalAppInstRunRecord,
          LocalAppInstRunRecord>
      get copyWith => _LocalAppInstRunRecordCopyWithImpl(
          this as LocalAppInstRunRecord, $identity, $identity);
  @override
  String toString() {
    return LocalAppInstRunRecordMapper.ensureInitialized()
        .stringifyValue(this as LocalAppInstRunRecord);
  }

  @override
  bool operator ==(Object other) {
    return LocalAppInstRunRecordMapper.ensureInitialized()
        .equalsValue(this as LocalAppInstRunRecord, other);
  }

  @override
  int get hashCode {
    return LocalAppInstRunRecordMapper.ensureInitialized()
        .hashValue(this as LocalAppInstRunRecord);
  }
}

extension LocalAppInstRunRecordValueCopy<$R, $Out>
    on ObjectCopyWith<$R, LocalAppInstRunRecord, $Out> {
  LocalAppInstRunRecordCopyWith<$R, LocalAppInstRunRecord, $Out>
      get $asLocalAppInstRunRecord =>
          $base.as((v, t, t2) => _LocalAppInstRunRecordCopyWithImpl(v, t, t2));
}

abstract class LocalAppInstRunRecordCopyWith<
    $R,
    $In extends LocalAppInstRunRecord,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? uuid, DateTime? startTime, DateTime? endTime});
  LocalAppInstRunRecordCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _LocalAppInstRunRecordCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, LocalAppInstRunRecord, $Out>
    implements LocalAppInstRunRecordCopyWith<$R, LocalAppInstRunRecord, $Out> {
  _LocalAppInstRunRecordCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<LocalAppInstRunRecord> $mapper =
      LocalAppInstRunRecordMapper.ensureInitialized();
  @override
  $R call({String? uuid, Object? startTime = $none, Object? endTime = $none}) =>
      $apply(FieldCopyWithData({
        if (uuid != null) #uuid: uuid,
  ...
  @override
  LocalAppInstRunRecord $make(CopyWithData data) => LocalAppInstRunRecord(
      uuid: data.get(#uuid, or: $value.uuid),
      startTime: data.get(#startTime, or: $value.startTime),
      endTime: data.get(#endTime, or: $value.endTime));

  @override
  LocalAppInstRunRecordCopyWith<$R2, LocalAppInstRunRecord, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _LocalAppInstRunRecordCopyWithImpl($value, $cast, t);
}
